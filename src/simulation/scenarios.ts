...
const base = {
  ...
  pushIntervalS: 1, tier2CycleS: 5, powerSaving: false, breakers: breakers(),
}
...
export const scenarios: ScenarioDefinition[] = [
  ...
  },
  {
    ...
    setup: { ...base, tier1: false, tier2: true, breakers: breakers({ 'sim-ac-unit': { switchOn: true } }), overrides: { pvW: 0, heatsinkC: 40, batteryVoltageV: 24.4, batteryChargeCurrentA: 0, batteryDischargeCurrentA: 49 } }, events: [],
    expectations: [
  ...
  },
  {
    ...
    description: 'Tier-1 sheds an overheated site; a later Tier-2 ON is blocked while heat remains high.',
